  ...
  <div class="text-xl text-primary-variant p-2">
    ...
    <div class="relative flex items-center gap-2">
      ...
      <button
        ...
        :aria-pressed="copied"
        title="Copy LaTeX"
        class="ml-2 p-2 text-on-surface-disabled hover:text-primary-variant focus:text-secondary-variant transition transform duration-100 ease-initial hover:scale-110 focus:scale-120 focus:outline-none"
