      ...
      >
        ...
        <div class="flex-1 overflow-auto py-4">
          <slot
            ...
            :model-value="projectProps"
            :onUpdate:model-value="(newValue: Record<string, unknown>) => (projectProps = newValue)"
          ></slot>
        </div>
        ...
        <div class="flex items-center justify-end gap-2 pt-4">
          <button
            @click="onCancel"
            class="px-2 py-1 rounded-xs font-medium text-on-surface bg-surface-2"
            type="button"
          >
            Cancel
          </button>
