      ...
      >
        <div v-if="currentProjectInfo" class="flex bg-surface-2 rounded-t-xs mt-1">
          <div
            ...
            class="w-45 mb-px flex items-center shrink-0 max-w-full border border-transparent rounded-xs hover:border-gray-300 focus-within:border-primary focus-within:hover:border-primary"
          >
          ...
          <button
            ...
            :class="
              stateManager.isSaving.value
                ? ''
                : 'hover:text-on-surface hover:bg-red-900 hover:border-on-surface'
            "
          >
            <span
