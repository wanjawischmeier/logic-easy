<template>
  <div class="inline-flex items-center gap-2">
    ...
    <div
      class="inline-flex items-center gap-0.5 rounded bg-surface-2 p-0.5 border border-surface-3"
    >
      <button
...
const isSelected = ref<boolean[]>(initialSelected?.value ?? Array(values.value.length).fill(true))
