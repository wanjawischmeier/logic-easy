    ...
    <div class="inline-flex items-center gap-2">
        ...
        <div class="inline-flex items-center gap-0.5 rounded bg-surface-2 p-0.5 border border-surface-3">
            <label class="cursor-pointer">
                <button type="button"
                    class="w-8 h-6 px-3 py-1.5 rounded-xs transition-colors duration-100 flex items-center justify-center"
                    :class="isChecked
                        ? 'bg-primary border-primary text-white'
                        : 'bg-surface-2 text-on-surface-variant hover:bg-surface-3 border border-surface-3 text-on-surface-disabled'"
                    @click="isChecked = !isChecked">
                    <svg v-if="isChecked" fill="currentColor" viewBox="5 5 14 14">
                        <path
                    ...
                    <svg v-else fill="currentColor" viewBox="10 10 30 30">
                        <path
